...
If I get good enough to be useful, I'd be interested in short-term, local 
projects for public good like this one:
http://www.dclibrary.org/node/28915

This project uses Python to help in the Hurricane Sandy recovery effort.
It's unlikely that I'm good enough to contribute yet, but it provides something 
towards which I can aspire.(I learned about it through an email Aaron Titus 
sent to the DC PYthon Meetup list.
http://code.google.com/p/sandy-disaster-recovery/source/browse/#svn%2Ftrunk%2Fsandy-disaster-recovery

Using Google Apps Scripts, it would be nice to write a program 
that automatically emails people the results when they take a quiz
with Google Forms. For starters, have it send individual emails
when the teacher clicks something. Start with this tutorial:
https://developers.google.com/apps-script/articles/mail_merge


Terms of Service; Didn't Read has an api and posts their source code on github. 
I'm not sure if their project has room for beginners to contribute, but I'm 
interested in the subject matter.
Links:
http://tos-dr.info/api.html
...
UpDate: Tom Baker's mklists project does this! https://github.com/tombaker/mklists
...
(or student) in the school is a pull-down option would be a real headache as a 
result, because I'd have to type in every name manually. Although there's
no way to make each name appear as a pull-down or radio-button 
choice, there appears to be a a way to make the form question a 
simple text box and to pull the answer from a spreadsheet. Check
out this link to follow up: 
http://support.google.com/drive/bin/answer.py?hl=en&answer=160000
